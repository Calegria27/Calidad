...
const Dropdown_Tarifado = (props) => {
    ...
    const handleOptionTarifado = (option, name) => {
        ...
        console.log(selectedTarifado)
        const dataTable={CtoEmpresa: object.CtoEmpresa, CtoCodigo: object.CtoCodigo, Sector: object.Sector, uFisica: object.uFisica, Cartilla: object.Cartilla,Tarifado: option}
